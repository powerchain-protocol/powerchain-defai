...
const COPY: Record<RouteHealth, { title: string; body: string; tone: string }> = {
  NORMAL: { title: "Route available", body: "The route is accepting new bridge transfers.", tone: "border-[#d4ddd8] bg-[#f1f4f2] text-[#214233] dark:border-[#29483c] dark:bg-[#09110e]/45 dark:text-[#e0e8e4]" },
  ...
  INCIDENT: { title: "Route incident", body: "Do not submit a new transfer until the route returns to a safe operating state.", tone: "border-rose-200 bg-rose-50 text-rose-800 dark:border-rose-900 dark:bg-rose-950/25 dark:text-rose-200" },
};
