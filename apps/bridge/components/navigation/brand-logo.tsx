...
export function BrandLogo({ inverse = false, compact = false, showText = false }: { inverse?: boolean; compact?: boolean; showText?: boolean }) {
  ...
  return (
    <Link href={APP_ROUTES.home} className="inline-flex items-center gap-2.5 rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#35584a]" aria-label="PowerChain DeFAI home">
