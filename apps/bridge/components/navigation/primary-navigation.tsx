        ...
        {navigation.map(([label, href]) => {
          ...
          return (
            <Link
              ...
              className={`shrink-0 rounded-lg px-3 py-2 font-semibold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${
                active
      ...
      {navigation.map(([label, href]) => {
        ...
        return (
          <Link
            ...
            href={href}
            aria-current={active ? "page" : undefined}
            className={`rounded-lg px-3 py-2 font-medium transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${
              active
