...
export function ActionStateButton({ children, pendingLabel = "Working…", onAction, disabled, className = "", ...props }: ActionStateButtonProps) {
  ...
  return (
    <button
      ...
      className={`min-h-11 rounded-xl px-4 text-sm font-semibold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 disabled:cursor-not-allowed disabled:opacity-60 ${className}`}
    >
