...
export function TransactionFeeSummary({ mode }: { mode:"swap"|"bridge" }) {
  ...
  if(mode==="swap") return <div className="mt-3 grid gap-2 rounded-[var(--pc-radius-control)] border border-slate-200 bg-white p-3.5 text-xs dark:border-white/10 dark:bg-[#08110e] sm:grid-cols-3" aria-label="Swap fees">
  ...
  return <div className="mt-3 grid gap-2 rounded-[var(--pc-radius-control)] border border-slate-200 bg-white p-3.5 text-xs dark:border-white/10 dark:bg-[#08110e] sm:grid-cols-3" aria-label="Bridge fees">
