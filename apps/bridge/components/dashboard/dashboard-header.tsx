...
export function DashboardHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-slate-200/80 bg-white/90 backdrop-blur-xl dark:border-white/10 dark:bg-[#070b09]/90 lg:static">
      <div className="flex min-h-16 items-center gap-3 px-4 sm:px-6 lg:min-h-20 lg:px-7">
        ...
        <Link href={APP_ROUTES.status} className="hidden min-h-9 items-center rounded-xl border border-slate-200 bg-white px-3 text-xs font-semibold text-slate-600 transition hover:border-[#9eafa7] hover:text-[#264b3b] md:flex dark:border-white/10 dark:bg-white/[0.03] dark:text-slate-300">Runtime status</Link>
