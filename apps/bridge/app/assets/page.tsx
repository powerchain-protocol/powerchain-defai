...
export const metadata: Metadata = {
  title: "Assets & Liquidity",
  description: "Inspect trusted PowerChain assets, connected-wallet portfolio balances and DEX liquidity discovery across Solana and Sui.",
};
